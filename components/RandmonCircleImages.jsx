...
const RandomCircleImages = ({ centerImage, surroundingImages }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <Image
        source={require("../assets/images/onboarding/face_5.jpeg")}
        style={[styles.surroundingImage, { top: 100, right: 60 }]}
      />
      <Image
        source={require("../assets/images/onboarding/face_2.jpg")}
        style={[styles.surroundingImage, { bottom: 0, right: 100 }]}
      />
      <Image
        source={require("../assets/images/onboarding/face_6.jpeg")}
        style={[styles.surroundingImage, { bottom: 0, left: 100 }]}
      />
